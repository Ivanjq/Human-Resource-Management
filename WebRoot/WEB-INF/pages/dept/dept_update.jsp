...
<table width="99%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr style="background:url(../img/main_locbg.gif) repeat-x; height:30px;">
		<td height="32">&nbsp;&nbsp;&nbsp;
			...
			<a href="main/selectDept2">部门管理</a>  &gt; 修改部门</td>
	</tr>
</table>

<form action="updateDeptView" method="post">
<table width="30%" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr  height="30">
		<td colspan="2"><input type="hidden" name="id" value="${dept.id}"></td>
	</tr>
	<tr height="30">
		<td width="30%">部门名称：</td>
